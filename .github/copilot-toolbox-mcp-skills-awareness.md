...
_Generated: 2026-05-16T21:55:56.429Z_
...
Workspace `mcp.json` _(folder: projeto_final_flutter)_

- **c:\Users\maria\computacao_movel_projects\projeto_final_flutter\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\maria\AppData\Roaming\Code\User\mcp.json** — _File exists — servers defined_

| Server id | Kind | Detail |
|-----------|------|--------|
| makenotion/notion-mcp-server | http | https://mcp.notion.com/sse |
